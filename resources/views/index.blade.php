...
<head>
    ...
    <!-- plugin CSS -->
    <link rel="stylesheet" href="{{ asset('static/style/bootstrap.min.css')}}">
            ...
            <div class="container">
                <div class="navbar navbar-main navbar-expand-lg">
                    ...
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-main-collapse" aria-controls="navbar-main-collapse" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"> <img src="{{ asset('static/img/menu.png')}}" alt="menu hamburguesa"></span>
                    </button>
    ...
    <main>
        ...
        <section class="effect-section">
            <div class="container-margin ">
                <div class="row justify-content-between align-items-center p-100px-tb full-screen content-dis-tablet ">
                    <div class="col-lg-6">
                        <div class="p-30px-tb">
                    ...
                    <div class="col-lg-6 text-center final-img">
         ...
         <section id="1" name="1" class="section p-10px-t">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-lg-6">
                        <img src="{{ asset('static/img/a1.svg ')}}" title="" alt="equipos e impresoras zebra" id="tablet-id-img">
                    </div>
...
<hr>
         ...
         <section id="2" name="2" class="section p-10px-t">
            <div class="container">
                <div class="row justify-content-between flex-img">
                    <div class="col-lg-6">
                        <img src="{{ asset('static/img/a2.svg ')}}" title="" alt="suministros zebra" id="tablet-id-img">
                    </div>
                    <div class="col-lg-5 align-self-center">
        ...
        <section id="3" name="3" class="section p-10px-t">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-lg-6">
                        <img src="{{ asset('static/img/a3.svg ')}}" title="" alt="desarrollo web sofware y soluciones digitales" id="tablet-id-img">
                    </div>
                    <div class="col-lg-5 align-self-center">
        ...
        <section id="4" name="4" class="section p-10px-t">
            <div class="container">
                <div class="row justify-content-between flex-img">
                    <div class="col-lg-6">
                        <img src="{{ asset('static/img/a4.svg')}}" title="" alt="escudo de servicio tecnico" id="tablet-id-img">
                    </div>
                    <div class="col-lg-5 align-self-center">
        ...
        <section id="5" class="section gray-bg grid-par">
            <div class="container certi-z">
                <div class="row md-m-25px-b m-45px-b tablet-tab">
                        <h3 class="h1 m-15px-b p-15px-b font-alt ">Somos especialistas en tecnología de identificación
y captura automatizada de datos.</h3>
                  ...
                  <div class="img-par">
                   <img src="{{ asset('/static/img/Asset 20.png')}}" alt="certificado de la empresa" id="part-img-">   
                  </div>
        ...
        <div class="tab-content content-dis-tablet">
            <!-- start tab content -->
            <div id="tab3_sec0" class="tab-pane fade in active show ">
               <div class="row align-items-center  p-25px-t md-p-15px-t content-dis-tablet">
